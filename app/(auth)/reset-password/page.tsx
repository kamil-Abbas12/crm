        ...
        <>
          ...
          {error && (
            <div className="mb-4 p-3 bg-red-950/60 border border-red-800/40 rounded-lg text-red-400 text-sm">
              ...
              {error.includes("expired") && (
                <div className="mt-2"><Link href="/forgot-password" className="text-red-300 underline text-xs">Request a new link →</Link></div>
              )}
            </div>
          )}
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" required placeholder="Re-enter password" value={form.confirm}
                ...
                className={`w-full bg-[#1a1a1a] border rounded-lg px-4 py-2.5 text-white placeholder-gray-700 text-sm outline-none transition ${
                  form.confirm && form.password !== form.confirm ? "border-red-700/60" : "border-white/8 focus:border-red-700/50"
                }`} />
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <Suspense fallback={
          <div className="bg-[#111] border border-white/8 rounded-2xl p-6 text-center text-gray-600 text-sm">Loading…</div>
        }>
          <ResetPasswordForm />
        </Suspense>
